...
Quand l'agent n'est pas sûr (score de confiance < 75 %), détecte un ton agressif, ou tombe sur une question hors de son périmètre, il **escalade** vers votre équipe humaine.
