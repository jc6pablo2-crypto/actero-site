...
<ResponseField name="confidence" type="number">Score de confiance du Brain entre 0 et 1. En dessous d'un seuil (0,75 par défaut, configurable par playbook), l'agent passe en `needs_review`.</ResponseField>
