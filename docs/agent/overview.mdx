...
<Note>
La pause coupe le canal **widget**. L'Agent Email a son propre interrupteur, lui aussi appliqué côté serveur, dans **Mon Agent → Agent Email**. Pour arrêter une automatisation précise sans tout couper, mets en pause le [playbook](/agent/playbooks) concerné.
</Note>
