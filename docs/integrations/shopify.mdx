...
2. À la fin de l'installation, tu es invité à créer ton compte Actero.
3. Dès que ton compte est créé, ta boutique y est rattachée automatiquement — rien à reconnecter.
