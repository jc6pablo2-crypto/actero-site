  ...
  return (
    <>
      ...
      <button
        onClick={handleOpen}
        disabled={!clientId}
        className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#0F5F35] hover:bg-[#003725] text-white text-[13px] font-semibold rounded-xl shadow-[0_1px_3px_rgba(0,0,0,0.08)] border border-[#0F5F35] disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
      >
                  ...
                  >
                    <div className="flex items-start gap-3">
                      ...
                      <div className="w-7 h-7 rounded-lg flex items-center justify-center flex-shrink-0 mt-0.5">
                        {r.status === 'loading' && (
                          <Loader2 className="w-4 h-4 text-[#0F5F35] animate-spin" />
                        )}
                        {r.status === 'ok' && (
                    ...
                    <div className="flex items-center justify-between gap-4">
                      ...
                      {!summary.operational && (
                        <button
                          ...
                          className="inline-flex items-center gap-1.5 px-3 py-2 bg-[#0F5F35] hover:bg-[#003725] text-white text-[12px] font-semibold rounded-lg transition-colors flex-shrink-0"
                        >
