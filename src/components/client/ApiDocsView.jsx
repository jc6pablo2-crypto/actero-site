          ...
          <div className="flex items-center justify-between">
            ...
            {!showCreateForm && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-2 rounded-lg bg-[#0F5F35] text-white text-xs font-semibold hover:bg-[#003725] transition-colors"
              >
          ...
          {showCreateForm && (
            <div className="flex items-center gap-2">
              <input
                ...
                className="flex-1 px-3 py-2.5 rounded-xl border border-gray-200 bg-white text-sm placeholder:text-[#9ca3af] focus:outline-none focus:ring-2 focus:ring-[#0F5F35]/20 focus:border-[#0F5F35]"
                onKeyDown={(e) => e.key === 'Enter' && handleCreate()}
                autoFocus
              />
              <button onClick={handleCreate} disabled={creating} className="px-4 py-2.5 rounded-xl bg-[#0F5F35] text-white text-sm font-semibold hover:bg-[#003725] disabled:opacity-50 transition-colors">
                {creating ? '...' : 'Créer'}
              </button>
        ...
        <div className="flex items-center gap-2 p-3 rounded-xl border border-gray-200 bg-white mb-4">
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-3 py-2 rounded-lg text-xs font-semibold transition-all ${
              copiedId === 'mcp' ? 'bg-emerald-50 text-emerald-600' : 'bg-[#0F5F35] text-white hover:bg-[#003725]'
            }`}
          >
