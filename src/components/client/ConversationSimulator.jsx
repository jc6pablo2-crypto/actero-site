      ...
      <div className="flex items-center justify-between">
        ...
        {activePlaybooks.length > 0 && (
          <button
            ...
            disabled={testingAll}
            className="flex items-center gap-2 px-4 py-2 bg-[#0F5F35] text-white text-sm font-bold rounded-full hover:bg-[#003725] disabled:opacity-50"
          >
              ...
              return (
                <button
                  ...
                  className={`p-4 rounded-xl border-2 text-left transition-all ${
                    ...
                    'border-gray-100 hover:border-[#0F5F35] hover:shadow-sm'
                  } disabled:opacity-50`}
                >
