          ...
          return (
            <motion.button
              ...
              className={`group text-left bg-white rounded-2xl border p-5 transition-all ${
                isAvailable
                  ? 'border-[#f0f0f0] hover:border-[#0F5F35]/25 hover:shadow-sm cursor-pointer'
            ...
            >
              ...
              {ch.status === 'available' && (
                <div className="mt-3 inline-flex items-center gap-1 text-[12px] font-semibold text-[#0F5F35]">
