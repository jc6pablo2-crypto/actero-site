  ...
  return (
    <motion.div
      ...
      className={`group rounded-2xl bg-white border shadow-[0_1px_3px_rgba(0,0,0,0.04)] transition-all hover:shadow-[0_4px_20px_rgba(0,0,0,0.06)] ${
        isActive ? 'border-[#0F5F35]/25' : 'border-[#f0f0f0]'
      }`}
    >
      <div className="p-5 md:p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-3 mb-1">
              <div className="min-w-0">
                <div className="flex items-center gap-2 flex-wrap">
                  ...
                  {status === 'active' && (
                    <span className="inline-flex items-center gap-1 px-2 py-0.5 bg-[#0F5F35]/10 text-[#0F5F35] text-[10px] font-bold rounded-full uppercase tracking-wider">
                      <span className="w-1.5 h-1.5 rounded-full bg-[#0F5F35] animate-pulse" /> Actif
                    </span>
                  )}
                  {status === 'missing' && (
                ...
                <p className="text-[12px] font-semibold text-[#0F5F35] mt-0.5">{automation.tagline}</p>
              </div>
            </div>
            ...
            {isActive && metricLine && (
              <div className="mt-3 flex items-center gap-2 text-[11px] text-[#0F5F35] font-medium">
              ...
              <button
                ...
                className={`inline-flex items-center gap-1.5 px-4 py-2 text-[12px] font-semibold rounded-xl transition-colors disabled:opacity-50 disabled:cursor-not-allowed ${
                  isActive
                    ...
                    : 'bg-[#0F5F35] hover:bg-[#003725] text-white'
                }`}
              >
                {isActive ? (
  ...
  return (
    <div className="max-w-6xl mx-auto px-5 md:px-8 pt-6 pb-16 animate-fade-in-up">
      ...
      <motion.div
        ...
        className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#0F5F35] via-[#0F5F35] to-[#003725] text-white p-6 md:p-10 mb-8"
      >
