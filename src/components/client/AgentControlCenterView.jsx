      ...
      >
        <div className="flex items-start justify-between gap-4 flex-wrap">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 text-[12px] font-semibold text-[#0F5F35] hover:text-[#003725] transition-colors"
          >
        ...
        {cards.map((card, idx) => {
          ...
          return (
            <motion.button
              ...
              className="group text-left bg-white rounded-2xl border border-[#f0f0f0] p-5 hover:border-[#0F5F35]/25 hover:shadow-sm transition-all"
            >
