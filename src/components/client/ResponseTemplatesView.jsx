              ...
              <div className="flex items-start justify-between gap-3 mb-2">
                <div className="min-w-0 flex-1">
                  <div className="flex items-center gap-2 flex-wrap mb-1">
                    ...
                    {tpl.shortcut && (
                      <span className="px-1.5 py-0.5 rounded text-[9px] font-bold bg-[#0F5F35]/10 text-[#0F5F35] border border-[#0F5F35]/20">
                        {tpl.shortcut}
                      </span>
                    )}
                    {tpl.category && (
              ...
              <div className="p-5 space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full bg-[#fafafa] border border-[#ebebeb] rounded-lg px-3 py-2 text-[13px] text-[#1a1a1a] outline-none resize-none focus:border-[#0F5F35]/30"
                  />
                </div>
              </div>
