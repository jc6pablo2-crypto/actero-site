...
const GUIDES = [
  ...
  { id: 'whatsapp-business', category: 'automatisations', title: 'Configurer WhatsApp Business', summary: 'Répondre aux clients sur WhatsApp (Pro).', icon: MessageSquare, readTime: '4 min',
    content: "WhatsApp Business est disponible sur le plan Pro uniquement.\n\n1. Allez dans Intégrations → WhatsApp\n2. Cliquez 'Connecter' et connectez-vous à Meta Business\n3. Sélectionnez votre numéro WhatsApp Business vérifié\n4. Autorisez Actero à recevoir et envoyer des messages\n5. Allez dans Automatisations → SAV E-commerce et cochez le canal WhatsApp\n\nL'agent répondra automatiquement aux messages WhatsApp avec le ton et la base de savoir configurés." },
