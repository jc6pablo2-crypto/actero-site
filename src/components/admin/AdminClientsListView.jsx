      ...
      <PageHeader
        ...
        actions={
          <button
            ...
            className="inline-flex items-center gap-1.5 h-8 px-3 rounded-lg bg-[#0F5F35] hover:bg-[#0a4a29] text-white text-[12px] font-semibold transition-colors"
          >
              ...
              return (
                <button
                  ...
                  className={`inline-flex items-center h-7 px-2.5 rounded-full border text-[11px] font-semibold transition-all ${
                    active
                      ? 'bg-[#0F5F35] border-[#0F5F35] text-white'
                  ...
                  {filteredSorted.map((c) => (
                    ...
                    >
                      <td className="px-4 py-2.5">
                        <div className="w-7 h-7 rounded-lg bg-[#0F5F35]/10 flex items-center justify-center text-[11px] font-bold text-[#0F5F35]">
        ...
        <form className="p-5 space-y-3" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="w-full h-9 px-3 rounded-xl bg-[#fafafa] border border-[#f0f0f0] text-[13px] text-[#1a1a1a] focus:outline-none focus:ring-2 focus:ring-[#0F5F35]/20 focus:border-[#0F5F35]/30"
          ...
          <div className="flex items-center justify-end gap-2 pt-2">
            ...
            <button
              type="submit"
              disabled={loading}
              className="h-9 px-4 rounded-lg bg-[#0F5F35] hover:bg-[#0a4a29] text-white text-[12px] font-semibold disabled:opacity-60"
            >
