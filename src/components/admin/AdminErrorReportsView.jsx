        ...
        <div className="p-6 space-y-5">
          ...
          <div>
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-semibold text-[#0F5F35] hover:bg-[#0F5F35]/5 transition-colors disabled:opacity-50"
              >
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 rounded-xl border border-gray-200 text-sm focus:outline-none focus:ring-2 focus:ring-[#0F5F35]/20"
            />
          </div>
