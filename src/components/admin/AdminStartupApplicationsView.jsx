      ...
      <div className="flex items-start justify-between gap-4 mb-6 flex-wrap">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-[#0F5F35]/10 flex items-center justify-center">
            <Rocket className="w-5 h-5 text-[#0F5F35]" />
          </div>
          <div>
                ...
                return (
                  <button
                    ...
                    className={`w-full text-left px-4 py-3 hover:bg-zinc-50 transition-colors ${
                      isSelected ? 'bg-[#0F5F35]/[0.03] border-l-2 border-l-[#0F5F35]' : ''
                    }`}
                  >
            ...
            >
              ...
              <div className="space-y-3 text-[13px]">
                <DetailRow icon={Globe} label="URL">
                  <a href={selected.url} target="_blank" rel="noopener noreferrer" className="text-[#0F5F35] hover:underline inline-flex items-center gap-1">
                    {selected.url}
                    <ExternalLink className="w-3 h-3" />
                  </a>
                </DetailRow>
                <DetailRow icon={Mail} label="Email">
                  <a href={`mailto:${selected.email}`} className="text-[#0F5F35] hover:underline font-mono">{selected.email}</a>
                </DetailRow>
              ...
              {selected.status === 'pending' && (
                <div className="pt-3 border-t border-[#f0f0f0] space-y-2">
                  <textarea
                    ...
                    rows={2}
                    className="w-full px-3 py-2 border border-[#f0f0f0] rounded-lg text-[12px] resize-none focus:outline-none focus:border-[#0F5F35]/30"
                  />
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2.5 rounded-lg text-[12px] font-bold bg-[#0F5F35] text-white hover:bg-[#003725] transition-colors disabled:opacity-50"
                    >
