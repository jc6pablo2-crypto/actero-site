      ...
      <div className="p-6 space-y-6">
        ...
        <SectionCard title="Créer les produits Stripe" icon={CreditCard}>
          ...
          <button
            ...
            disabled={creating}
            className="px-4 py-2 rounded-xl text-[13px] font-semibold bg-[#0F5F35] text-white hover:bg-[#0F5F35]/90 disabled:opacity-50 flex items-center gap-2"
          >
            {creating ? (
              <>
        ...
        <SectionCard title="Variables d'environnement necessaires" icon={AlertTriangle}>
          ...
          <div className="mt-4 pt-4 border-t border-[#f0f0f0]">
            <a
              ...
              className="inline-flex items-center gap-1.5 text-[13px] font-semibold text-[#0F5F35] hover:underline"
            >
              Gerer sur Vercel
