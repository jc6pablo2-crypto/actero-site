...
const MockupAudit = ({ isImmo }) => (
  <div className="bg-[#0d0d0d] rounded-xl border border-white/[0.06] p-4 text-[11px] font-mono">
      ...
      {steps.map((block, i) => (
        <FadeInUp key={`${vertical}-${i}`} delay={i * 0.12}>
          <GlowCard
            ...
            className="bg-[#0a0a0a] rounded-[28px] border border-white/[0.06] h-full hover:border-white/[0.12] transition-all duration-500 overflow-hidden"
          >
