...
export const ProcessSteps = ({ vertical, onNavigate }) => {
  ...
  const steps = isImmo ? [
  ...
  ] : [
    {
      step: '01',
      icon: <Activity className="w-5 h-5 text-[#003725]" />,
      title: 'Connexion en 2 clics',
      desc: "Connectez Shopify et vos outils (CRM, support, email) en quelques clics. Aucune compétence technique requise.",
      detail: '5 minutes',
    ...
    },
    {
      step: '02',
      icon: <Zap className="w-5 h-5 text-[#003725]" />,
      title: 'Activation des agents',
      desc: "Configurez vos agents IA depuis le dashboard. Choisissez vos scénarios, personnalisez le ton, et activez en un clic.",
      detail: '10 minutes',
