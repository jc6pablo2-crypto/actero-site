      ...
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold tracking-tight text-[#1a1a1a] mb-4">
            ...
            <span className="text-[#0F5F35]">en 30 secondes.</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 gap-6 items-start">
          ...
          >
            ...
            <div className="bg-[#fafafa] border border-[#f0f0f0] rounded-2xl p-6 text-center">
              <p className="text-[10px] font-bold text-[#0F5F35] uppercase tracking-[0.15em] mb-2">
                ROI mensuel estime
              </p>
              <motion.p
              ...
              >
                ...
                <span className="text-2xl text-[#0F5F35]">€</span>
              </motion.p>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-white border border-[#f0f0f0] rounded-2xl p-4">
                <div className="flex items-center gap-1.5 mb-2">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#0F5F35]" />
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-2 px-6 py-3.5 rounded-full bg-[#0F5F35] hover:bg-[#003725] text-white font-semibold text-[13px] transition-all group"
            >
              {reco.cta}
