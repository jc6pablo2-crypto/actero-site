...
export const AmbassadorLandingPage = ({ onNavigate }) => {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: '30 jours après l\'encaissement effectif du client.',
    },
    {
        ...
        <main>
          ...
          <section className="pt-36 pb-24 md:pt-44 md:pb-32 px-6">
            <FadeInUp className="max-w-4xl mx-auto text-center">
              ...
              <p className="text-xl md:text-2xl text-gray-400 font-medium max-w-2xl mx-auto leading-relaxed mb-12">
                Recommandez Actero à votre entourage professionnel. Si votre contact devient client, vous êtes récompensé.
              </p>
              ...
              {steps.map((step, i) => (
                <StaggerItem key={i}>
                  <div className="relative p-8 rounded-3xl bg-[#111] border border-white/10 hover:border-emerald-500/30 transition-all group">
                    <div className="absolute -top-4 -left-2 w-8 h-8 rounded-full bg-emerald-500 text-black flex items-center justify-center font-bold text-sm">
                      {i + 1}
                    </div>
