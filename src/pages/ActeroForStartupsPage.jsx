        ...
        <main>
          ...
          <section className="pt-32 md:pt-40 pb-20 px-6 bg-white">
            <div className="max-w-4xl mx-auto text-center">
              <FadeInUp className="mb-6">
                <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#0F5F35]/10 text-[#0F5F35] text-sm font-bold">
              ...
              <FadeInUp delay={0.1}>
                ...
                <p className="text-2xl md:text-3xl font-bold text-[#0F5F35]">
                  -50% pendant 6 mois.
                </p>
              </FadeInUp>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <FadeInUp>
                <div className="grid md:grid-cols-2 gap-4 max-w-2xl mx-auto">
                  {[
                    { icon: <ShoppingCart className="w-5 h-5 text-[#0F5F35]" />, text: 'Boutique e-commerce de moins de 2 ans' },
                    { icon: <Star className="w-5 h-5 text-[#0F5F35]" />, text: "CA < 500k\u20AC/an" },
                    { icon: <Zap className="w-5 h-5 text-[#0F5F35]" />, text: 'Shopify, WooCommerce ou Webflow' },
                    { icon: <MessageSquare className="w-5 h-5 text-[#0F5F35]" />, text: 'Engagement de donner du feedback produit' }
                  ].map((item, i) => (
            ...
            <div className="max-w-4xl mx-auto">
              ...
              <StaggerContainer className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  <StaggerItem key={i}>
                    <div className="bg-[#0F5F35] rounded-2xl p-6 border border-white/10">
          ...
          <section className="py-20 px-6 bg-white" id="candidature">
            <div className="max-w-2xl mx-auto">
              ...
              <FadeInUp delay={0.1}>
                {submitted ? (
                  <div className="bg-[#0F5F35]/10 rounded-2xl p-10 text-center border border-[#0F5F35]/20">
                    <CheckCircle2 className="w-12 h-12 text-[#0F5F35] mx-auto mb-4" />
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F9F7F1] text-[#262626] text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#0F5F35]/30 focus:border-[#0F5F35] transition"
                      />
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F9F7F1] text-[#262626] text-sm font-medium focus:outline-none focus:ring-2 focus:ring-[#0F5F35]/30 focus:border-[#0F5F35] transition resize-none"
                      />
                    </div>
                    ...
                    <button
                      type="submit"
                      disabled={loading}
                      className="w-full py-4 px-6 rounded-xl bg-[#0F5F35] text-white font-bold text-base flex items-center justify-center gap-2 hover:bg-[#003725] transition-colors disabled:opacity-60"
                    >
