  ...
  ecommerce: [
    {
      ...
      icon: 'https://cdn.shopify.com/shopifycloud/web/assets/v1/vite/client/en/assets/favicon-Bpa4JMpT.svg',
      authType: 'oauth',
      oauthPrompt: 'shop',
      oauthPromptLabel: 'Entrez votre domaine Shopify (ex: ma-boutique.myshopify.com)',
    ...
    },
    {
      ...
      icon: 'https://www.gorgias.com/favicon.ico',
      authType: 'oauth',
      oauthPrompt: 'subdomain',
      oauthPromptLabel: 'Entrez votre sous-domaine Gorgias (ex: ma-boutique)',
    ...
    },
    {
      ...
      icon: 'https://www.freshdesk.com/favicon.ico',
      authType: 'coming_soon',
      category: 'ecommerce',
