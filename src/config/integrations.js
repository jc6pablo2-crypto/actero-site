export const INTEGRATIONS = {
  ecommerce: [
    ...
    },
    {
      id: 'webflow',
      name: 'Webflow',
      description: 'Synchronisez votre boutique Webflow — commandes, clients, produits',
      icon: '/integrations/webflow.png',
      authType: 'api_key',
      apiKeyLabel: 'Token API Webflow',
      apiKeyPlaceholder: 'wf_xxx...',
      apiKeyHint: 'Allez dans Project Settings → Integrations → API Access',
      category: 'ecommerce',
    ...
    },
    {
      id: 'woocommerce',
      name: 'WooCommerce',
      description: 'Connectez votre boutique WooCommerce WordPress — commandes, clients',
      icon: '/integrations/woocommerce.png',
      authType: 'api_key',
      apiKeyLabel: 'Consumer Key + Secret WooCommerce',
      apiKeyPlaceholder: 'ck_xxx...',
      apiKeyHint: 'WooCommerce → Reglages → Avance → REST API → Ajouter une cle',
      category: 'ecommerce',
