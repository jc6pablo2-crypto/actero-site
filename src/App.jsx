      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-[#0a0a0a] py-8 px-4 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-white/10 sm:rounded-3xl sm:px-10">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div>
              <label className="block text-sm font-bold text-white mb-2">Email professionnel</label>
            ...
            {!isForgot && (
              <div>
                ...
                <div className="flex items-center justify-end mt-3">
                  <button type="button" onClick={() => { setIsForgot(true); setError(''); setSuccess(''); }} className="text-sm text-zinc-500 hover:text-white font-medium transition-colors">
                    Mot de passe oublié ?
                  </button>
                </div>
              </div>
            ...
            {isForgot && (
              <button type="button" onClick={() => { setIsForgot(false); setError(''); setSuccess(''); }} className="w-full text-center text-sm text-zinc-500 hover:text-white font-medium mt-4">
        ...
        <div className="mt-8 text-center text-xs text-zinc-500 max-w-xs mx-auto font-medium leading-relaxed">
      ...
      <nav className="fixed top-0 w-full z-50 bg-[#030303]/70 backdrop-blur-2xl border-b border-white/10/50 shadow-sm transition-all duration-300">
        <div className="max-w-6xl mx-auto px-6 h-16 md:h-20 flex justify-between items-center">
          ...
          <div className="hidden lg:flex items-center gap-8 absolute left-1/2 -translate-x-1/2">
            <button onClick={() => scrollToId('produit')} className="text-sm font-semibold text-gray-400 hover:text-white transition-colors">Produit</button>
            <button onClick={() => scrollToId('cas-usage')} className="text-sm font-semibold text-gray-400 hover:text-white transition-colors">Cas d'usage</button>
            <button onClick={() => scrollToId('roi')} className="text-sm font-semibold text-gray-400 hover:text-white transition-colors">ROI</button>
