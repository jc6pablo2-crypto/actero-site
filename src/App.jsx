...
const AlternativeIntercom = lazy(() => import("./pages/AlternativeIntercom").then(m => ({ default: m.AlternativeIntercom })));
...
function MainRouter() {
  ...
  else if (currentRoute === "/alternative-intercom") page = <AlternativeIntercom onNavigate={navigate} />;
